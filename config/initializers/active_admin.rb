ActiveAdmin.setup do |config|
  ...
  # Authenticates through the app's own User model and session - no Devise.
  ...
  # No commenting on records: it adds a table and a UI nobody here asked for.
